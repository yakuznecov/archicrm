...
const UploadDocumentsS3 = () => {
	...
	// id клиента
	const contractClientId = useContractsStore((state) => state.contractId);

	// Загрузка файлов по id договора
	useEffect(() => {
		if (contractClientId) {
			YandexService.getByClient(contractClientId);
		}
	}, [contractClientId]);
	...
	return (
		<>
			...
			>
				...
				<Flex align='center' justify='center'>
					<Image.PreviewGroup>
						<Image width={175} height={175} src={path} />
					</Image.PreviewGroup>
				</Flex>
			</Modal>
		</>
...
export default UploadDocumentsS3;
